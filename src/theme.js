...
export const STATUS = {
  ok:     { text: 'text-green-500',  bg: 'bg-green-500',  soft: 'bg-green-500/12',  border: 'border-green-500/30',  hex: '#22c55e' },
  warn:   { text: 'text-amber-500',  bg: 'bg-amber-500',  soft: 'bg-amber-500/12',  border: 'border-amber-500/30',  hex: '#eab308' },
  danger: { text: 'text-red-400',    bg: 'bg-red-400',    soft: 'bg-red-400/10',    border: 'border-red-400/25',    hex: '#f87171' },
...
export const MACRO_COLORS = {
  ...
  carbs:   { hex: '#eab308', text: 'text-amber-500',  label: 'Karbo' },
  fat:     { hex: '#f87171', text: 'text-red-400',    label: 'Lemak' },
};
